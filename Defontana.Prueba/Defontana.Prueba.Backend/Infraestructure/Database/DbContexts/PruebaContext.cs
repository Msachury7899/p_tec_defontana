...
namespace Defontana.Prueba.Backend.Infraestructure.Database.DbContexts
{
    public partial class PruebaContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=tcp:lab-defontana-202310.caporvnn6sbh.us-east-1.rds.amazonaws.com,1433; Initial Catalog=Prueba; Persist Security Info=False; User ID =ReadOnly;Password=d*3PSf2MmRX9vJtA5sgwSphCVQ26*T53uU; Encrypt = True; TrustServerCertificate = True; Connection Timeout = 30;");
            }
        }
